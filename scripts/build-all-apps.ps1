...
# Orchestrates compiling all 5 TUI applications (helm, pulse, scout, trance, ignite)
...
Write-Host "Building all 5 TUI apps (Release=$Release)" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
...
if ($failed.Count -eq 0) {
    Write-Host "All 5 TUI apps compiled successfully!" -ForegroundColor Green
    Write-Host "==========================================" -ForegroundColor Green
    exit 0
} else {
